  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col">
        {/* Mobile Header - Slim and Professional */}
        <header className="lg:hidden mobile-header">
          <div className="mobile-header-logo">
            ...
            <span className="font-bold text-blue-600">Watch & Earn</span>
          </div>
        ...
        {/* Desktop Header */}
        <header className="hidden lg:block professional-header shadow-sm">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 p-2 text-gray-700 hover:text-blue-600 hover:bg-gray-100 rounded-lg transition-colors"
                >
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 professional-user-menu rounded-lg py-2 z-50">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-40">
            ...
            <div className="fixed inset-y-0 left-0 flex flex-col w-80 bg-white shadow-xl mobile-fade-in">
              <div className="flex items-center justify-center h-16 px-6 border-b border-gray-200">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center mr-3">
                    <TrendingUp className="w-5 h-5 text-white" />
        ...
        <main className="flex-1 overflow-auto">
          <div className="mobile-container lg:py-6 lg:px-8">
            {children}
          </div>
        </main>
